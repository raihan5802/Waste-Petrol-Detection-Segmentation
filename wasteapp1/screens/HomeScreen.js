...
//       // Once complaint is sent, clear the image and location from homescreen
//       setSelectedImage(null);
//       setLocation(null);
//       setIsGalleryImage(false);
//     } catch (e) {
...
//               window.ReactNativeWebView.postMessage(JSON.stringify({action:'select', latitude: latlng.lat, longitude: latlng.lng}));
//             } else {
//               // If no marker is placed, do nothing
//             }
//           });
...
//           <Button title="Select Location" onPress={openLocationSelector} />
//         </View>
//       )}
//       {location && (
