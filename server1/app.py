...
#     with open(app.config['CSV_FILE'], 'w', newline='') as f:
#         writer = csv.writer(f)
#         writer.writerow(['image_id','latitude','longitude','pixel_area','status'])
...
#     with open(app.config['CSV_FILE'], 'a', newline='') as f:
#         writer = csv.writer(f)
#         writer.writerow([image_id, latitude, longitude, pixel_area, 'processing'])

#     return jsonify(message="Complaint Registered!", image_id=image_id)
